...
function Card({svg, info}){
    return (
        <Grid container xs={12} alignItems={"center"}>
            <img src={svg}/>
            <Typography style={styles.paymentinfo} textAlign={"center"}>{info}</Typography>
        </Grid>
    )
}
...
export default function Checkout(){
    return (
        <Grid container style={styles.container} gap={3}>
            ...
            <Typography gutterBottom style={styles.heading} >Payment</Typography>
            ...
            <Grid item xs={12}>
                <Typography style={styles.heading} gutterBottom >Delivery Details</Typography>
                <Typography style={styles.details} >798 Maple Street, Los Angeles<br/>CA 90001<br/>(888)987-6543</Typography>
            </Grid>
            <Grid container item xs={12}>
                <Grid item xs={12}>
                    <Typography style={styles.heading} gutterBottom >Order Details</Typography>
                </Grid>
                {
                    ['1x Green Salad', '3x Grilled steak', '1x Fresh Veggie'].map((item, idx) => {
                        return (
                            <Grid item key={idx} xs={6}>
                                <Typography style={styles.details}>{item}</Typography>
                            </Grid>
                        )
                    })
                }
            </Grid>
            <ActionArea tag={"Total"} price={133.03} btnText={"Pay Now"} />
        </Grid>
    )
}